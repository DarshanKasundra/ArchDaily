...
//
//public class ListOfUserOfEventDetailAdapter extends RecyclerView.Adapter<ListOfUserOfEventDetailAdapter.UsersViewHolder> {
//
//    private Activity context;
//    private ArrayList<ListEvent> listEvents;
//
//    public ListOfUserOfEventDetailAdapter(Activity context, ArrayList<ListEvent> listEvents) {
...
//        View view = LayoutInflater.from(context).inflate( R.layout.recyclerview_list_of_event_of_user_details, parent, false);
